...
This is a GNOME Shell extension to generate TOTP (Time-based OTP) and HOTP (counter-based
OTP) authentication codes (such as the ones used by Google, Facebook, Github, Steam, etc).
